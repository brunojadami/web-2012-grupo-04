...
function validateForm()
{
    ...
    return validate(form["generalName"].value, /[a-z ]{2,30}/i, "Nome inválido.")
        ...
        && validate(form["generalCountry"].value, /.(*)/i, "País inválido.")
        && validate(form["generalCpf"].value, /[0-9]{3}\.[0-9]{3}\.[0-9]{3}-[0-9]{2}/i, "CPF inválido.")
        && validate(form["generalSex"].value, /.(*)/i, "Sexo inválido.")
        ...
        && validate(form["idState"].value, /.(*)/i, "Estado da identidade inválido.")
        && validate(form["idEmissionDate"].value, /[0-9]{1,2}\/[0-9]{1,2}\/[0-9]{2,4}/i, "Data de emissão da identidade inválida.")
        && validate(form["birthCountry"].value, /.(*)/i, "País de nascimento inválido.")
        && validate(form["birthState"].value, /.(*)/i, "Estado de nascimento inválido.")
        ...
        && validate(form["passportCountry"].value, /.(*)/i, "País do passaporte inválido.")
        ...
        && validate(form["addressCountry"].value, /.(*)/i, "País do endereço inválido.")
        && validate(form["addressDistrict"].value, /[a-z ]{2,40}/i, "Bairro do endereço inválido.")
        && validate(form["addressState"].value, /.(*)/i, "Estado do endereço inválido.")
        ...
        && validate(form["professionalAddressCountry"].value, /.(*)/i, "País do endereço profissional inválido.")
        && validate(form["professionalAddressDistrict"].value, /[a-z ]{2,40}/i, "Bairro do endereço profissional inválido.")
        && validate(form["professionalAddressState"].value, /.(*)/i, "Estado do endereço profissional inválido.")
